...
//kitchen.addToMenu(newBurger).then(console.log).then(kitchen.readMenu().then(console.log)).catch(console.log);
...
Promise.all(customers.map(a => kitchen.order(a.order))).then((data) => console.log('All Food Delivered\n', data)).catch(console.log);