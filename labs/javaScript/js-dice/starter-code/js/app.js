...
function rollDice() {
    ...
    let dice1 = document.getElementById("first-die")
    let dice2 = document.getElementById("second-die")
    dice1.className = "dice dice-" + random1;
    dice2.className = "dice dice-" + random2;
}
